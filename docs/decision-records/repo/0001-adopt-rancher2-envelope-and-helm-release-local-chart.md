...
- [ADR-repo/0012](0012-use-terraform-native-workload-resources.md) for the `helm_release`, Helm provider, local chart delivery, and golden chart starter clauses. This ADR's Rancher envelope and disposable real-provider CI decisions remain current.
